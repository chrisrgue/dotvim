...
silent only
cd ~/Dropbox/workspace_svn_isource/haltools
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 common/lib/codec.rb
badd +1 ~/.vimrc
badd +4 ~/tabularize_example_input.txt
badd +0 ~/.vim_without_pathogen/.vimrc
silent! argdel *
edit ~/.vim_without_pathogen/.vimrc
...
exe 'vert 2resize ' . ((&columns * 72 + 71) / 143)
exe '3resize ' . ((&lines * 28 + 16) / 32)
exe 'vert 3resize ' . ((&columns * 68 + 71) / 143)
exe '4resize ' . ((&lines * 28 + 16) / 32)
exe 'vert 4resize ' . ((&columns * 1 + 71) / 143)
argglobal
enew
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 196 - ((5 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
196
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 14 - ((0 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
