...
set shortmess=aoO
badd +0 port_migration.rb
badd +0 ~/.vimrc
args port_migration.rb
edit ~/.vimrc
...
exe 'vert 2resize ' . ((&columns * 67 + 68) / 137)
exe '3resize ' . ((&lines * 37 + 20) / 41)
exe 'vert 3resize ' . ((&columns * 69 + 68) / 137)
argglobal
enew
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 273 - ((3 * winheight(0) + 18) / 37)
...
unlet! s:wipebuf
set winheight=9999 winwidth=9999 shortmess=filnxtToO
